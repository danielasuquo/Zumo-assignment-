...
class App:
    ...
    def __init__(self, root):
        #setting title
        root.title("Pololu Zumo Robot Control Interface : Task 4")
        ...
        self.RightGyroButton.place(x=1254,y=260,width=180,height=80)
        ...
        self.LeftGyroButton.place(x=954,y=260,width=180,height=80)
