...
class App:
    ...
    def __init__(self, root):
        #setting title
        root.title("Pololu Zumo Robot Control Interface : Task 3")
        #setting window size
        width=762
        height=628
        ...
        self.AUTOButton.place(x=290,y=460,width=180,height=80)
        ...
        Main_Label_0.place(x=260,y=10,width=251,height=37)
        ...
        Main_Label_1.place(x=300,y=40,width=166,height=30)
        ...
        Main_Label_2.place(x=180,y=70,width=400,height=61)
        ...
        self.State_Label_0.place(x=280,y=560,width=200,height=30)
