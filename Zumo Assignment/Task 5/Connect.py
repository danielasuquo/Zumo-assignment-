...
def GyroRight():
    print("Direction : Gyroscope Right")
    robot.write(bytes("E", 'utf-8'))
    time.sleep(0.05)
...
def GyroLeft():
    print("Direction : Gyroscope Left")
    robot.write(bytes("Q", 'utf-8'))
    time.sleep(0.05)
...
def SearchRight():
    ...
    robot.write(bytes("I", 'utf-8'))
    time.sleep(0.05)

def SearchLeft():
    print("Searching : Left")
    robot.write(bytes("U", 'utf-8'))
    time.sleep(0.05)
